...
public class CommonMethods {
	...
	public static String randomString(int numCarattere) {
		char[] caratteri = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r',
				's', 't', 'u', 'v', 'w', 'x', 'y', 'z' };
	 ...
	 * switch (mese) {
	 * 
	 * case 1: Mese = "Gennaio"; break; case 2: Mese = "Febbario"; break; case 3:
	 * Mese = "Marzo"; break; case 4: Mese = "Aprile"; break; case 5: Mese =
	 * "Maggio"; break; case 6: Mese = "Giugno"; break; case 7: Mese = "Luglio";
	 * break; case 8: Mese = "Agosto"; break; case 9: Mese = "Settembre"; break;
	 * case 10: Mese = "Ottobre"; break; case 11: Mese = "Novembre"; break; case 12:
	 * Mese = "Dicembre"; break; default: break;
	 * 
	 * }
	 * 
